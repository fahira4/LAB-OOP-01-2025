...
public class App {
    public static void main(String[] args) {
        ...
        //membuat objek helikopter
        Helikopter helikopter = new Helikopter("Bell", "206B-3");
        helikopter.setJumlahBalingBaling(4);
        helikopter.setTipeMesin("Turboshaft");
        helikopter.setKecepatan(1000);
        helikopter.setTahunProduksi(1983);
        helikopter.setWarna("Biru");
        System.out.println("\n==== HELIKOPTER ====");
        System.out.println("Merek: " + helikopter.getMerek());
        System.out.println("Model: " + helikopter.getModel());
        System.out.println("Jumlah Baling-Baling: " + helikopter.getJumlahBalingBaling());
        System.out.println("Tipe Mesin: " + helikopter.getTipeMesin());
        System.out.println("Kecepatan: " + helikopter.getKecepatan());
        System.out.println("Tahun produksi: " + helikopter.getTahunProduksi());
    }
}
